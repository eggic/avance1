...
<div class="container mt-5">
    ...
    <div class="comidas-apiladas">
        @forelse($productos as $producto) <!-- Cambié foreach por forelse -->
        <div class="mb-4">
        ...
        @empty
            <p class="text-center">No hay productos disponibles.</p> <!-- Mensaje cuando no hay productos -->
        @endforelse
    </div>
